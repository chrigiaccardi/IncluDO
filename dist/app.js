...
const corso3 = new Corso("Assistente Infermieristico e Sanitario", "Percorso di formazione per nuove figure di supporto nel settore sanitario", "Sanità e assistenza infermieristica", 8);
const corso4 = new Corso("Contabilità aziendale e gestione finanziaria", "Introduzione ai principi di contabilità e gestione bilanci per piccole imprese", "Contabilità", 1);
const corso5 = new Corso("Sviluppo Web e programmazione di base", "Corso Introduttivo alle tecnologie informatiche", "Informatica", 3);
// Creazione Aziende
const azienda1 = new Azienda("EduMondo Cooperativa Sociale", "Educazione e pedagogia sociale", "Cooperativa che promuove l’integrazione culturale e il supporto educativo per bambini e famiglie straniere");
const azienda2 = new Azienda("MechPro Solutions", "Meccanica Industriale", "Azienda specializzata nella manutenzione e assistenza tecnica per impianti e macchinari industriali");
const azienda3 = new Azienda("SalusCare Italia", "Sanità e assistenza infermieristica", "Struttura privata convenzionata che offre assistenza infermieristica, domiciliare e hospice");
const azienda4 = new Azienda("Contabix Studio Associato", "Contabilità", "Studio professionale che offre servizi di contabilità, gestione paghe e consulenza aziendale");
const azienda5 = new Azienda("CodeForge Tech", "Informatica", "Startup tecnologica che sviluppa applicazioni web e mobile per aziende italiane e internazionali");
